...
export default function Dashboard() {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 6 }}>
      ...
      <Typography variant="h3" sx={{ fontFamily: 'Roboto Slab, serif', color: '#0f154a', mt: 0.5, maxWidth: 820 }}>
      ...
      <Grid container spacing={3} sx={{ mt: 4 }}>
        <Grid size={{ xs: 12, md: 7 }}>
          <Paper elevation={2} sx={{ p: { xs: 3, md: 4 }, borderTop: '4px solid #1a237e', height: '100%' }}>
            <Chip label="Featured" size="small" sx={{ backgroundColor: '#e8eaf6', color: '#1a237e', fontWeight: 600 }} />
            <Typography variant="h5" sx={{ fontFamily: 'Roboto Slab, serif', mt: 2, color: '#0f154a' }}>
              {featured.title}
            </Typography>
        ...
        <Grid size={{ xs: 12, md: 5 }}>
          <Paper elevation={0} sx={{ p: { xs: 3, md: 4 }, backgroundColor: '#f6f7fb', height: '100%' }}>
            <Typography variant="overline" sx={{ color: '#1a237e', letterSpacing: '0.12em', fontWeight: 700 }}>
              How the layers work
            </Typography>
            <Box sx={{ mt: 1.5 }}>
              {LAYERS.map((l) => (
                <Box key={l.n} sx={{ display: 'flex', gap: 2, mb: 2 }}>
                  ...
                  <Box>
                    <Typography variant="body1" sx={{ fontWeight: 600, color: '#0f154a' }}>
                      {l.label}
                    </Typography>
